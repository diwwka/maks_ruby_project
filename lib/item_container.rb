module Tarnovetskyi
  module ItemContainer
    module ClassMethods
      # Метод класу: повертає інформацію про клас (версію) 
      def class_info
    ...
    module InstanceMethods
      # a. add_item: Додає товар до колекції 
      def add_item(item)
        @items << item
    ...
    # Callback-метод: Запускається автоматично при include 
